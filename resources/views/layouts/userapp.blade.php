  ...
  <!--        <button class="nav-item " ><i class="fa fa-home"></i> Home</button>   -->   
            <li class="nav-item">
              <a class="nav-link " href="/admin">
                ...
                <h6>Hi {{ Auth::user()->name }}</h6> <span class="sr-only">(current)</span>
              </a>
            ...
            <li class="nav-item">
              <a class="nav-link"  href="/user-catering">
                <span data-feather="file"></span>
                Catering Packages
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/user-food">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/get-notification">
            <span data-feather="users"></span>
            Notifications
          </a>
        </li>
